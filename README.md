...
<div class="edge">
    <div class="box">
        ...
        <h3> S.MANOJ KUMAR  (212223040097)</h3>
        <form method="POST">
            {% csrf_token %}
            <div class="formelt">
...
![Screenshot 2024-04-28 221804](https://github.com/ManojKumarShankar/MathServer/assets/122000959/d476edcc-b072-4f92-a1ff-0bf4dd7379ee)




## HOMEPAGE:
![Screenshot 2024-04-28 221700](https://github.com/ManojKumarShankar/MathServer/assets/122000959/43feaab1-bf9f-43f0-a4ee-f318c2c86871)
